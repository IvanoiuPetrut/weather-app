...
export default {
  ...
  computed: {
    ...
    precipitation() {
      return this.isMm
        ? `${
            this.forecast[this.currentDayId].hour[this.hourIndex].precip_mm
          } mm`
        : `${
            this.forecast[this.currentDayId].hour[this.hourIndex].precip_in
          } in`;
    },
    wind() {
      return this.isKmH
        ? `${
            this.forecast[this.currentDayId].hour[this.hourIndex].wind_kph
          } km/h`
        : `${
            this.forecast[this.currentDayId].hour[this.hourIndex].wind_mph
          } mph`;
    },
    pressure() {
      return this.isMb
        ? `${
            this.forecast[this.currentDayId].hour[this.hourIndex].pressure_mb
          } mb`
        : `${
            this.forecast[this.currentDayId].hour[this.hourIndex].pressure_in
          } in`;
    },
    visibility() {
      return this.isKm
        ? `${this.forecast[this.currentDayId].hour[this.hourIndex].vis_km} km`
        : `${
            this.forecast[this.currentDayId].hour[this.hourIndex].vis_miles
          } miles`;
    },
    uvIndex() {
      return this.forecast[this.currentDayId].hour[this.hourIndex].uv;
    },
    howGoodIsUvIndex() {
